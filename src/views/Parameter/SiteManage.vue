   ...
   <div class="public-main organize-box">
      <div class="organizeL-box" style='padding: 0'>
         <el-menu
            ...
            <el-submenu :index="indexFirst+''" :data-index="indexFirst+''" v-for="(siteFirst,indexFirst) in siteArr2"
                        :key="indexFirst">
               <template slot="title">
               ...
               <el-menu-item :index="indexFirst+''+'-'+indexSecond+''" :data-index="indexFirst+''+'-'+indexSecond+''"
                             v-for="(siteSecond,indexSecond) in siteFirst.child" :key="indexSecond"
                             class="site-item">
      ...
      <div class="organizeR-box">
         <div class="alignR">
            <el-button icon="el-icon-folder-add" @click="FnBtnAddShow" :loading="btnState.btnAdd" class="public-btn">
               新增国家站点
            </el-button>
         </div>
      ...
      <el-dialog :append-to-body="true"
         ...
         <el-form :model="addSiteForm" ref="RefAddSiteForm" label-width="136px" class="public-diaForm">
            <el-form-item label="区域站点名称：" prop="regionName"
                          :rules="{ required: true, message: '请输入区域站点名称', trigger: 'blur' }">
               <el-input type="text" v-model="addSiteForm.regionName" autocomplete="off" clearable
                         placeholder="区域站点名称"></el-input>
            </el-form-item>
            <el-form-item label="所属平台：" prop="plateName"
                          :rules="{ required: true, message: '请输入所属平台', trigger: 'blur' }">
               <el-input type="text" v-model="addSiteForm.plateName" autocomplete="off" clearable
                         placeholder="所属平台"></el-input>
            </el-form-item>
            <el-form-item label="描述：" prop="note">
               <el-input type="textarea" v-model="addSiteForm.note" autocomplete="off" clearable
      ...
      <el-dialog :append-to-body="true"
         ...
         <el-form :model="addForm" ref="RefAddForm" label-width="160px" class="public-diaForm">
            ...
            <el-form-item label="国家站点名称：" prop="country"
                          :rules="{ required: true, message: '请输入国家站点名称', trigger: 'blur' }">
               <el-input type="text" v-model="addForm.country" autocomplete="off" clearable
                         placeholder="国家站点名称"></el-input>
            </el-form-item>
            <el-form-item label="所属区域站点：" prop="site"
                          :rules="{ required: true, message: '请输入所属区域站点', trigger: 'blur' }">
               <el-input type="text" v-model="addForm.site" autocomplete="off" clearable
                         placeholder="所属区域站点"></el-input>
            </el-form-item>
            <el-form-item label="所在国家：" prop="hostCountry"
                          :rules="{ required: true, message: '请输入所在国家', trigger: 'blur' }">
               <el-input type="text" v-model="addForm.hostCountry" autocomplete="off" clearable
                         placeholder="所在国家"></el-input>
            </el-form-item>
            <el-form-item label="交易结算货币类型：" prop="currencyCode"
                          :rules="{ required: true, message: '请输入交易结算货币类型', trigger: 'blur' }">
               <el-input type="text" v-model="addForm.currencyCode" autocomplete="off" clearable
                         placeholder="交易结算货币类型"></el-input>
            </el-form-item>
...
<script>
import {listSite,getSite} from "@/assets/js/api"
