<template>
   <div class="public-main">
      <el-form :model="FormSearch" class="public-form" ref="refRoleForm"
         ...
         <el-select v-model="FormSearch.people" value.key="id" filterable clearable placeholder="创建人"
                    class="public-select">
         ...
         <el-select v-model="FormSearch.site" value.key="id" filterable clearable placeholder="站点"
                    class="public-select">
            <el-option v-for="(item, index) in projectArr" :key="index"
                       :value="item.value"
                       :label="item.label">
         ...
         <el-select v-model="FormSearch.store" value.key="id" filterable clearable placeholder="店铺"
                    class="public-select">
            <el-option v-for="(item, index) in projectArr" :key="index"
                       :value="item.value"
                       :label="item.label">
         ...
         <el-input v-model="FormSearch.name" class="public-input" autocomplete="off" placeholder="ASIN"
                   clearable></el-input>
         <el-input v-model="FormSearch.name" class="public-input" autocomplete="off" placeholder="关键词"
                   clearable></el-input>
      ...
      <el-table class="public-table" border
         ...
         <el-table-column prop="keywordNum" label="关键词数量"></el-table-column>
